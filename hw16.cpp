...
bool even(int x) { /* temp, replace when defining function... */ return false; } // test for even ints via modulo

//------------------------------------------------------------------------------

bool less_than_31(int x) { /* temp, replace when defining function... */ return false; }

//------------------------------------------------------------------------------

int global_value; // the value to which less_than_v() compares its argument
bool less_than_v(int x) { /* temp, replace when defining function... */ return false; }
